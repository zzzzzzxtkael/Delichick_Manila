...
class OrderCore extends ObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'total_profit' => array('type' => self::TYPE_FLOAT, 'required' => true),
    ...
    {
        $sql = 'SELECT sum((P.price-P.wholesale_price)*C.quantity) FROM ' . _DB_PREFIX_ . 'cart_product as C LEFT Join ' . _DB_PREFIX_ . 'product as P on C.id_product = P.id_product where id_cart =' . (int) $this->id_cart;
        
        $result = Db::getInstance()->getValue($sql);
        $this->total_profit = $result;
