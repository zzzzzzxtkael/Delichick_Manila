    ...
    <div class="row">
      ...
      <div class="col-xs-6 col-sm-3 box-stats color4" >
        <div class="kpi-content">
          ...
          <span class="value">{displayPrice price=$order->total_profit currency=$currency->id}</span>
        </div>
      </div>
      ...
      <div class="col-xs-6 col-sm-3 box-stats color4" >
        <div class="kpi-content">
          ...
          <span class="value">{displayPrice price=$order->total_paid_tax_incl - $order->total_profit currency=$currency->id}</span>
        </div>
      </div>
